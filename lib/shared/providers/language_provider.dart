...
class LanguageProvider extends ChangeNotifier {
  ...
  Future<void> initialize(TTSService ttsService, SpeechService speechService) async {
  ...
  Future<void> _loadLanguagePreference() async {
    try {
      ...
      if (savedLanguage != null && ['english', 'swahili'].contains(savedLanguage)) {
        _currentLanguage = savedLanguage;
        if (kDebugMode) print('🌍 Loaded language preference: $_currentLanguage');
      }
    } catch (e) {
